...
func _ready():
	...
	dcol.button_pressed = f.disable_collision
	dvel.button_pressed = f.draw_velocity
	dfor.button_pressed = f.draw_force
	dview.button_pressed = f.draw_fov
	...
	show_button.connect("pressed", Callable(self, "toggle_visible"))
	hide_button.connect("pressed", Callable(self, "toggle_visible"))
	reset_button.connect("pressed", Callable(self, "reset"))
	pause_button.connect("pressed", Callable(self, "pause_boids"))
	visible = false
...
func reset():
	pop_lock.button_pressed = false
	mspeed_lock.button_pressed = false
	mforce_lock.button_pressed = false
	vrad_lock.button_pressed = false
	vang_lock.button_pressed = false
	trad_lock.button_pressed = false
	brad_lock.button_pressed = false
	mass_lock.button_pressed = false
	master_lock.button_pressed = false
	seek_lock.button_pressed = false
	sep_lock.button_pressed = false
	ali_lock.button_pressed = false
	coh_lock.button_pressed = false
	ran_lock.button_pressed = false
	gra_lock.button_pressed = false
	wind_lock.button_pressed = false
	fri_lock.button_pressed = false
	master_disable.button_pressed = false
	f.master_disable = false
	seek_disable.button_pressed = false
	f.seek_disable = false
	sep_disable.button_pressed = false
	f.seek_disable = false
	ali_disable.button_pressed = false
	f.align_disable = false
	coh_disable.button_pressed = false
	f.cohesion_disable = false
	ran_disable.button_pressed = false
	f.random_disable = false
	gra_disable.button_pressed = false
	f.gravity_disable = false
	wind_disable.button_pressed = false
	f.wind_disable = false
	fri_disable.button_pressed = false
	...
	dcol.button_pressed = false
	f.disable_collision = false
	dvel.button_pressed = false
	f.draw_force = false
	dfor.button_pressed = false
	f.draw_force = false
	dview.button_pressed = false
	f.draw_fov = false
	f.update()
...
func _on_masterdisable_toggled(button_pressed):
	...
	seek_disable.button_pressed = button_pressed
	sep_disable.button_pressed = button_pressed
	ali_disable.button_pressed = button_pressed
	coh_disable.button_pressed = button_pressed
	ran_disable.button_pressed = button_pressed
	gra_disable.button_pressed = button_pressed
	wind_disable.button_pressed = button_pressed
	fri_disable.button_pressed = button_pressed
